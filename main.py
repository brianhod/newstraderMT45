...
mt5.initialize(login=51139012, server="ICMarketsSC-Demo", password="T4rW6JA7")
gap = 3
tp = 45
sl = 0.75
symbol = "EURUSD"
volume = 0.5
set = datetime(2023,3,10,19,0,0,100000)
...
# sell_stop(symbol,0.5,L,sell_tp,O + sl*(O-L))
# buy_stop(symbol,0.5,H,buy_tp,O - sl*(O-L))
